...
export default function AnalyticsPage() {
  const tdee = useMemo(
    () => computeWeeklyTDEE([80, 80, 80, 80, 80, 80, 80], [2500, 2600, 2550, 2450, 2650, 2500, 2550]),
    []
  );
      ...
      <section className="container py-6 space-y-4">
        <PaywallGate title="Analytics is Premium">
          ...
          <div className="card">
            ...
            <p className="text-gray-400 text-sm mb-3">Your estimated average TDEE over the last 7 days.</p>
